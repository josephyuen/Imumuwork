...
import com.zumumu.imumu.ui.shop.activity.ShopCartActivity;
...
public class ShopCartAdapter extends RecyclerView.Adapter {
    ...
    public ShopCartAdapter(Context context, Activity activity, ShopCartBean bean) {
        mContext = context;
        mActivity = activity;
        this.bean = bean;
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        ...
        holder1.btnShopcartAdd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                holder1.tvShopcartNum.setText(bean.getData().get(position).getGoods_quantity()+"");
                ShopCartActivity shopCartActivity = (ShopCartActivity) mActivity;
                if(bean.getData().get(position).isItemChecked()){
                    ...
                    shopCartActivity.changeAllPrice();
                }
            }
        });
