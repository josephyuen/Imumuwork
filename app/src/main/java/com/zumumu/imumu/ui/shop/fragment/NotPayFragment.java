...
public class NotPayFragment extends BaseLazyFragment<MyIndentPresenter, MyIndentModel> implements MyIndentContract.MyIndentSuperView{
    ...
    protected void initView() {
        IndentAdapter mAdapter = new IndentAdapter(getContext(),10,"待付款");
