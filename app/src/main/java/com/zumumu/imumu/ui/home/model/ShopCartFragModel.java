...
public class ShopCartFragModel implements ShopCartFragContract.ShopCartFragSuperModel {

    @Override
    public Observable<String> loadShopCartFragChannels(final String s) {
    ...
    @Override
    public Observable<String> loadShopCartFragDelete(final String s) {
        return Observable.create(new Observable.OnSubscribe<String>() {
            @Override
            public void call(final Subscriber<? super String> subscriber) {
    ...
    @Override
    public Observable<String> loadShopCartFragBuyNow(final BuyNowBean bean) {
        return Observable.create(new Observable.OnSubscribe<String>() {
            @Override
            public void call(final Subscriber<? super String> subscriber) {
